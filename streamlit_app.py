...
if page == pages[1]:
    ...
    fig = plt.figure()
    sns.countplot(x = "Survived", data=df, palette={"1": 'orange', "0": 'blue'})
    st.pyplot(fig)
    ...
    st.pyplot(fig)
    st.write("#### We observe that the majority of passengers are men in Class 3 whose age varies mainly between 20 and 40 years.")
